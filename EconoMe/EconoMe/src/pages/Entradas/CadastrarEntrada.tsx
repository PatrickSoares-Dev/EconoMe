...
const CadastrarEntrada: React.FC = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                const categoriasEntrada = categoriasResponse.data.$values.filter((cat: any) => cat.tipo === 'Entrada');
    ...
    const handleInputChange = (e: CustomEvent) => {
        setValor(e.detail.value as string);
    };
        ...
        <IonPage>
            <IonContent fullscreen>
                <IonHeader className='bg-green' style={{ padding: '20px', textAlign: 'center', borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px' }}>
                    <IonCardSubtitle style={{ color: 'white', margin: '0', fontWeight: 'bold', fontSize: '1.2rem' }}>Entradas</IonCardSubtitle>
